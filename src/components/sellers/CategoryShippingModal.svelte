...
{#if show}
  <div
    class="modal-overlay category-shipping-modal"
    role="button"
    tabindex="0"
    onclick={onClose}
    ...
    >
      ...
      <div class="modal-body">
        <div class="form-section">
          <h3>{$_("seller_dashboard.category_shipping")}</h3>

          <div class="form-group">
            <label class="form-label" for="category-select">
              {$_("seller_dashboard.select_category_for_shipping")} *
            </label>
            <select
              id="category-select"
              bind:value={form.category_shortname}
              class="form-select"
            >
              <option value="">
                {$_("seller_dashboard.select_category_for_shipping")}
